...
export default {
  ...
  setup() {
    ...
    const fetchCustomers = async () => {
      try {
        const response = await axios.get("https://fafabank-app-z7hg.onrender.com/employees/customer-accounts");
    ...
    const updateDailyLimit = async () => {
      try {
        await axios.put("https://fafabank-app-z7hg.onrender.com/employees/customer-accounts", {
    ...
    const closeAccount = async (customerId) => {
      try {
        const response = await axios.delete(`https://fafabank-app-z7hg.onrender.com/employees/close-account/${customerId}`);
